...
public class ImageBank {
    ...
    public static Image blue_circle;
    public static Image brown_circle;
    public static Image green_circle;
    public static Image orange_circle;
    public static Image pink_circle;
    public static Image purple_circle;
    public static Image red_circle;
    public static Image yellow_circle;
    ...
    public static Image blue_circle_eyes;
    public static Image brown_circle_eyes;
    public static Image green_circle_eyes;
    public static Image orange_circle_eyes;
    public static Image pink_circle_eyes;
    public static Image purple_circle_eyes;
    public static Image red_circle_eyes;
    public static Image yellow_circle_eyes;
    ...
    public static Image blue_square;
    public static Image brown_square;
    public static Image green_square;
    public static Image orange_square;
    public static Image pink_square;
    public static Image purple_square;
    public static Image red_square;
    public static Image yellow_square;
    ...
    public static Image blue_square_eyes;
    public static Image brown_square_eyes;
    public static Image green_square_eyes;
    public static Image orange_square_eyes;
    public static Image pink_square_eyes;
    public static Image purple_square_eyes;
    public static Image red_square_eyes;
    public static Image yellow_square_eyes;
